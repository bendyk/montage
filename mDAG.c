...
int main(int argc, char **argv)
{
  ...
  if(path)
   ...
   fprintf(fdag, "      xsi:schemaLocation=\"http://pegasus.isi.edu/schema/DAX http://pegasus.isi.edu/schema/dax-3.6.xsd\"\n");
   fprintf(fdag, "      version=\"3.6\" count=\"1\" index=\"0\" name=\"montage\">\n\n");
...
//XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
   fprintf(fdag, "<transformation name=\"mDiffFit\" version=\"3.0\">\n");
   fprintf(fdag, "    <uses name=\"mDiffFit\"  version=\"3.0\"/>\n");
   fprintf(fdag, "    <uses name=\"mDiff\"     version=\"3.0\"/>\n");
   fprintf(fdag, "    <uses name=\"mFitplane\" version=\"3.0\"/>\n");
   fprintf(fdag, "</transformation>\n\n");
   cntr = 0;
   ...
   while(1)
   {
      ...
      //xxxfprintf(fdag,"  <job id=\"ID%06d\" name=\"%s\" version=\"3.0\" level=\"%d\" dv-name=\"mProject%d\" dv-version=\"1.0\">\n", id, mproj, level, cntr);

      fprintf(fdag,"  <job id=\"ID%06d\" name=\"%s\" version=\"3.0\" >\n", id, mproj );
     ...
     fprintf(fdag,"    <uses name=\"p%s.fits\" link=\"output\" register=\"false\" transfer=\"true\"/>\n", fname);

      sprintf(key, "p%s.fits", fname);
      sprintf(val, "ID%06d", id);
      HT_add_entry(depends, key, val);

      fprintf(fdag,"    <uses name=\"p%s_area.fits\" link=\"output\" register=\"false\" transfer=\"true\"/>\n", fname);
   ...
   /*fprintf(fdag, "<executable name=\"mDiff\" version=\"3.0\" arch=\"x86_64\" os=\"linux\" installed=\"false\">\n");
   fprintf(fdag, "    <pfn url=\"file:///home/condor/Downloads/montage/bin\" site=\"local\"/>\n");
   fprintf(fdag, "</executable>\n");
   */
   ...
   while(1)
   {
      ...
      fname[strlen(fname) - 5] = '\0';
//XXXXXXXXXXX
      fprintf(fdag, "  <job id=\"ID%06d\" name=\"mDiffFit\" version=\"3.0\" >\n", id);
      ...
      fprintf(fdag, "    <uses name=\"fit.%06d.%06d.txt\" link=\"output\" register=\"false\" transfer=\"true\"/>\n",
         cntr1, cntr2);
      ...
      fprintf(fdag, "    <uses name=\"diff.%06d.%06d.fits\" link=\"output\" register=\"false\" transfer=\"true\" optional=\"true\"/>\n", cntr1, cntr2);
   ...
   fprintf(fdag, "  <job id=\"ID%06d\" name=\"mConcatFit\" version=\"3.0\" >\n", id);
   ...
   fprintf(fdag, "  <job id=\"ID%06d\" name=\"mBgModel\" version=\"3.0\"> \n", id);
   ...
   while(1)
   {
      ...
      fprintf(fdag, "  <job id=\"ID%06d\" name=\"mBackground\" version=\"3.0\"> \n", id);
   ...
   if(numTiles > 1)
   {
      for(i=0; i<numTilesX; ++i)
      {
         for(j=0; j<numTilesY; ++j)
         {
            ...
            fprintf(fdag, "  <job id=\"ID%06d\" name=\"mImgtbl\" version=\"3.0\">\n", 
               id);
   ...
   if(numTiles > 1)
   {
      for(i=0; i<numTilesX; ++i)
      {
         for(j=0; j<numTilesY; ++j)
         {
            ...
            fprintf(fdag, "  <job id=\"ID%06d\" name=\"mAdd\" version=\"3.0\">\n", 
               id);
   ...
   if(numTiles > 1)
   {
      for(i=0; i<numTilesX; ++i)
      {
         for(j=0; j<numTilesY; ++j)
         {
            ...
            fprintf(fdag, "  <job id=\"ID%06d\" name=\"mShrink\" version=\"3.0\">\n", id);
   ...
   fprintf(fdag, "  <job id=\"ID%06d\" name=\"mJPEG\" version=\"3.0\">\n", id);
   ...
   fprintf(fdag, "    <uses name=\"dag_%s.xml\" link=\"input\" transfer=\"true\"/>\n", idstr);
   fprintf(fdag, "    <uses name=\"dag_%s.xml\" link=\"output\" register=\"false\" transfer=\"true\"/>\n", idstr);

   sprintf(key, "dag.xml");
   sprintf(val, "ID%06d", id);
   HT_add_entry(depends, key, val);

   fprintf(fdag, "    <uses name=\"images_%s.tbl\" link=\"input\" transfer=\"true\"/>\n", idstr);
   fprintf(fdag, "    <uses name=\"images_%s.tbl\" link=\"output\" register=\"false\" transfer=\"true\"/>\n", idstr);
